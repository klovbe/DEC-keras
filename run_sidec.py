...
python_path = "C:/ProgramData/Anaconda/python.exe"
script_path = "F:/project/DEC-keras/sparse_idec.py"
done_path = "F:/project/DEC_keras/done_train.txt"
done_model_names = ["baron", "macosko", "shekhar"]
...
for i, file in enumerate(name_list):
    ...
    **par_dict
    ...
    print("running {}...".format(cmd))
    ret = subprocess.check_call(cmd, shell=True, cwd="F:/project/DEC-keras")
    print(ret)